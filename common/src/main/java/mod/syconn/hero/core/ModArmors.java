...
public class ModArmors {
    ...
    private static final ArmorMaterial MARK_42 = registerIronman(15, SoundEvents.ARMOR_EQUIP_IRON, Ingredient.of(Items.GOLD_BLOCK), "mark_42");
    private static final ArmorMaterial MARK_43 = registerIronman(17, SoundEvents.ARMOR_EQUIP_IRON, Ingredient.of(Items.IRON_INGOT), "mark_43");
    private static final ArmorMaterial WAR_MACHINE = registerIronman(23, SoundEvents.ARMOR_EQUIP_IRON, Ingredient.of(Items.IRON_INGOT), "war_machine");
